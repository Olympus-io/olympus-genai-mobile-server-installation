...
:::note
The 30 GB minimum covers Docker images (~18 GB across ~35 containers), databases at rest, and basic operating headroom. Add more for the files you'll manage — see the storage planner below.
:::
