        ...
        },
        {
          ...
          items: [
            { label: 'Olympus Website', href: 'https://www.olympus.io' },
            {
              ...
              href: 'https://github.com/Olympus-io/olympus-genai-mobile-server-installation/tree/main/olympus-file-server',
            },
            {
              label: 'OpenClaw AI Skill',
              href: 'https://github.com/Olympus-io/olympus-genai-mobile-server-installation/tree/main/openclaw',
            },
          ],
        },
        {
