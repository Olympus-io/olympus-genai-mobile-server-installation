...
> **<https://olympus-io.github.io/olympus-genai-mobile-server-installation/>**
...
| [`olympus-file-server/`](./olympus-file-server) | Postman collection — full API reference for the Olympus mobile-server API. |
| [`openclaw/`](./openclaw) | OpenClaw AI skill definition — 34 operations across files, sharing, comments, GenAI. |
...
Then open <http://localhost:8888> in your browser and complete the 8-step setup wizard.

> The full guide — including Windows commands, GPU setup, pre-flight checks, and troubleshooting — is at the **[docs site](https://olympus-io.github.io/olympus-genai-mobile-server-installation/)** or in [`SETUP.md`](./SETUP.md).
